...
<p>For each data storage server, Sahakaara not require any operating system installed because Sahakaara use pxelinux server to load the operating system to each Chunk server. With no operating system is installed the hard drive that can be used to form the greater its capacity Storege Clustering.</p>
